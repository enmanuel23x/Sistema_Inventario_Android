package unknown.project1_v001.ADD;
...
import unknown.project1_v001.TABLAS.tab_vendedor;
...
public class add_vendedores extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private boolean isExist(String n){
        ...
        Cursor c = db.rawQuery("SELECT "+ tab_vendedor.CAMPO_NOMBRE+" FROM "+ tab_vendedor.TABLA_VENDEDORES+" ORDER BY " + tab_vendedor.CAMPO_NOMBRE + " asc",null);
        if (checkdb(c)) {
            c.moveToFirst();
            do{
