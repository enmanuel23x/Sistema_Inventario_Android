...
import unknown.project1_v001.TABLAS.tab_user;
import unknown.project1_v001.menu_admin;
import unknown.project1_v001.ADD.add_usuarios;
...
public class usuarios extends AppCompatActivity {
    ...
    private void backf(){
        Intent intent = new Intent (getApplicationContext(), menu_admin.class);
        intent.putExtra("grade",grade);
